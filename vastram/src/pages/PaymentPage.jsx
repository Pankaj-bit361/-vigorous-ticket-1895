        ...
        >
          ...
          >
            ...
            >
              ...
              <Box fontWeight={600}> 1. Shipping</Box>
            </Stack>
            ...
            <Stack
              ...
              borderRadius={5}
            >
              <Text fontWeight={"500"} fontSize={"xl"} mb={"15px"}>
                Shipping by Vastram
              </Text>
            ...
            >
              ...
              <Text mt={"10px"} mb={"10px"}>
                Have a vastram Reward Dollars certificate? Enter it below!
              </Text>
                ...
                <CardBody>
                  <Stack spacing="5">
                    ...
                    <Box>
                      <Flex>
                        ...
                        <Box ml="3">
                          <Text fontWeight="600">Use a Different Address</Text>
                        </Box>
                      </Flex>
                    </Box>
                  </Stack>
                  ...
                  <Stack mt={"20px"}>
                    ...
                    >
                      ...
                      <Text fontWeight={"400"} color={"blue"} as="u">
